...
class Wbq{
	 ...
	 */
  	...
  	private function addText(){
  		...
  		//颜色
		$text1_color = imagecolorallocate($this->img, 200, 200, 204);
		$text2_color = imagecolorallocate($this->img, 200, 200, 204);
		$text3_color = imagecolorallocate($this->img, 200, 200, 204);


		//文字1
		imagefttext($this->img, 16, 0, 50, 188, $text1_color, $this->font_file, $this->text1);

		//文字2
		imagefttext($this->img, 16, 0, 50, 385, $text2_color, $this->font_file, $this->text2);

		//文字3
		imagefttext($this->img, 16, 0, 50, 585, $text3_color, $this->font_file, $this->text3);
  	}
