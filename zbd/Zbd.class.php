...
class Zbd{
	 ...
	 */
  	...
  	private function addText(){
  		...
  		//颜色
		$text1_color = imagecolorallocate($this->img, 255, 255, 255);
		$text2_color = imagecolorallocate($this->img, 255, 255, 255);


		//文字1
		imagefttext($this->img, 16, 0, 70, 267, $text1_color, $this->font_file, $this->text1);

		//文字2
		imagefttext($this->img, 16, 0, 70, 533, $text2_color, $this->font_file, $this->text2);
  	}
